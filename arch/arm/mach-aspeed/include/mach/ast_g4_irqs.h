...
#ifndef _AST_G4_IRQS_H_
#define _AST_G4_IRQS_H_                 1

#define NR_IRQS							(AST_VIC_NUM + AST_FIQ_NUM + ARCH_NR_I2C + ARCH_NR_GPIOS + ARCH_NR_SGPIOS + ARCH_NR_SDHCI + (AST_CVIC_NUM * MAX_AST1070_NR) + ARCH_NR_GPIOS + ARCH_NR_SGPIOS)
