 ...
 *
 *	 History	  :
 *	 1. 2013/03/12 Ryan Chen modify initial
 *
 ********************************************************************************/
...
static void ftgmac100_init_hw(struct ftgmac100 *priv)
{
	...
	//Ryan Add
//	iowrite32(0x44f97, priv->base + FTGMAC100_OFFSET_DBLAC);
	iowrite32(0x1010, priv->base + FTGMAC100_OFFSET_ITC);
...
static int ftgmac100_mdiobus_read(struct mii_bus *bus, int phy_addr, int regnum)
{
...
#ifdef AST_MAC_OWN
	if (ioread32(priv->base + FTGMAC100_OFFSET_PHYSTS) & FTGMAC100_PHY_STS_UNVALID) {
		printf("owner \n");
	} else {
		printf("not owner \n"); 
		iowrite32((ioread32(priv->base + FTGMAC100_OFFSET_PHYSTS) | FTGMAC100_PHY_REQ_EN, priv->base + FTGMAC100_OFFSET_PHYSTS);
	...
	fear0 = ioread32(priv->base + FTGMAC100_OFFSET_FEAR0);
	if(fear0 & (1 << 31)) {
