...
//	printk("apb_clk %d \n", apb_clk);
	...
	ast_gpio_write(gpio_bank, gpio_bank->timer0 * (apb_clk/1000000), gpio->config->gpio_debounce_timer );
	ast_gpio_write(gpio_bank, gpio_bank->timer1 * (apb_clk/1000000), gpio->config->gpio_debounce_timer + 0x04);
	ast_gpio_write(gpio_bank, gpio_bank->timer2 * (apb_clk/1000000), gpio->config->gpio_debounce_timer + 0x08);
