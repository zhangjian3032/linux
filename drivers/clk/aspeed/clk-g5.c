						 ...
						 unsigned long clkin_rate)
{
	...
	printk("aspeed_clk_hpll_recalc_rate %d\n", rate);
						...
						unsigned long hpll_rate)
{
	...
	printk("aspeed_clk_ahb_recalc_rate %d\n", rate);
						...
						unsigned long hpll_rate)
{
	...
	printk("aspeed_clk_apb_recalc_rate %d\n", rate);
