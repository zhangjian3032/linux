...
SIG_EXPR_LIST_DECL_SESG(B22, SD2CMD, SD2, SIG_DESC_SET(SCU4B4, 17),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(B22, SALT10, SALT10G0, SALT10, SIG_DESC_SET(SCU694, 17));
...
SIG_EXPR_LIST_DECL_SESG(C21, SD2DAT0, SD2, SIG_DESC_SET(SCU4B4, 18),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(C21, SALT11, SALT11G0, SALT11, SIG_DESC_SET(SCU694, 18));
...
SIG_EXPR_LIST_DECL_SESG(A22, SD2DAT1, SD2, SIG_DESC_SET(SCU4B4, 19),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(A22, SALT12, SALT12G0, SALT12, SIG_DESC_SET(SCU694, 19));
...
SIG_EXPR_LIST_DECL_SESG(A21, SD2DAT2, SD2, SIG_DESC_SET(SCU4B4, 20),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(A21, SALT13, SALT13G0, SALT13, SIG_DESC_SET(SCU694, 20));
...
SIG_EXPR_LIST_DECL_SESG(E20, SD2DAT3, SD2, SIG_DESC_SET(SCU4B4, 21),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(E20, SALT14, SALT14G0, SALT14, SIG_DESC_SET(SCU694, 21));
...
SIG_EXPR_LIST_DECL_SESG(D21, SD2CD, SD2, SIG_DESC_SET(SCU4B4, 22),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(D21, SALT15, SALT15G0, SALT15, SIG_DESC_SET(SCU694, 22));
...
SIG_EXPR_LIST_DECL_SESG(B21, SD2WP, SD2, SIG_DESC_SET(SCU4B4, 23),
			  SIG_DESC_SET(SCU450, 1));
SIG_EXPR_LIST_DECL_SEMG(B21, SALT16, SALT16G0, SALT16, SIG_DESC_SET(SCU694, 23));
...
SIG_EXPR_LIST_DECL_SEMG(AB10, RXD12, UART12G1, UART12, SIG_DESC_SET(SCU4D4, 31));
...
#define AE12 196
SIG_EXPR_LIST_DECL_SESG(AE12, FWSPIDQ2, FWQSPID, SIG_DESC_SET(SCU438, 4));
SIG_EXPR_LIST_DECL_SESG(AE12, GPIOY4, GPIOY4);
PIN_DECL_(AE12, SIG_EXPR_LIST_PTR(AE12, FWSPIDQ2),
	  SIG_EXPR_LIST_PTR(AE12, GPIOY4));

#define AF12 197
SIG_EXPR_LIST_DECL_SESG(AF12, FWSPIDQ3, FWQSPID, SIG_DESC_SET(SCU438, 5));
SIG_EXPR_LIST_DECL_SESG(AF12, GPIOY5, GPIOY5);
PIN_DECL_(AF12, SIG_EXPR_LIST_PTR(AF12, FWSPIDQ3),
	  SIG_EXPR_LIST_PTR(AF12, GPIOY5));

FUNC_GROUP_DECL(FWQSPID, AE12, AF12);
...
SIG_EXPR_LIST_DECL_SEMG(AD11, TXD13, UART13G1, UART13, SIG_DESC_CLEAR(SCU438, 14), SIG_DESC_SET(SCU4D8, 14));
PIN_DECL_2(AD11, GPIOZ6, SPI1DQ2, TXD13);

#define AF10 207
SIG_EXPR_LIST_DECL_SEMG(AF10, SPI1DQ3, QSPI1, SPI1, SIG_DESC_SET(SCU438, 15));
SIG_EXPR_LIST_DECL_SEMG(AF10, RXD13, UART13G1, UART13, SIG_DESC_CLEAR(SCU438, 15), SIG_DESC_SET(SCU4D8, 15));
...
#define AB4 232
SIG_EXPR_LIST_DECL_SESG(AB4, EMMCCLK, EMMC, SIG_DESC_SET(SCU400, 24));
PIN_DECL_1(AB4, GPIO18D0, EMMCCLK);

#define AA4 233
SIG_EXPR_LIST_DECL_SESG(AA4, EMMCCMD, EMMC, SIG_DESC_SET(SCU400, 25));
PIN_DECL_1(AA4, GPIO18D1, EMMCCMD);

#define AC4 234
SIG_EXPR_LIST_DECL_SESG(AC4, EMMCDAT0, EMMC, SIG_DESC_SET(SCU400, 26));
PIN_DECL_1(AC4, GPIO18D2, EMMCDAT0);

#define AA5 235
SIG_EXPR_LIST_DECL_SESG(AA5, EMMCDAT1, EMMC, SIG_DESC_SET(SCU400, 27));
PIN_DECL_1(AA5, GPIO18D3, EMMCDAT1);

#define Y5 236
SIG_EXPR_LIST_DECL_SESG(Y5, EMMCDAT2, EMMC, SIG_DESC_SET(SCU400, 28));
PIN_DECL_1(Y5, GPIO18D4, EMMCDAT2);

#define AB5 237
SIG_EXPR_LIST_DECL_SESG(AB5, EMMCDAT3, EMMC, SIG_DESC_SET(SCU400, 29));
PIN_DECL_1(AB5, GPIO18D5, EMMCDAT3);

#define AB6 238
SIG_EXPR_LIST_DECL_SESG(AB6, EMMCCD, EMMC, SIG_DESC_SET(SCU400, 30));
PIN_DECL_1(AB6, GPIO18D6, EMMCCD);

#define AC5 239
SIG_EXPR_LIST_DECL_SESG(AC5, EMMCWP, EMMC, SIG_DESC_SET(SCU400, 31));
PIN_DECL_1(AC5, GPIO18D7, EMMCWP);

FUNC_GROUP_DECL(EMMC, AB4, AA4, AC4, AA5, Y5, AB5, AB6, AC5);

#define Y1 240
SIG_EXPR_LIST_DECL_SESG(Y1, FWSPI18CS, FWSPI18, SIG_DESC_SET(SCU500, 3));
SIG_EXPR_LIST_DECL_SESG(Y1, VBCS, VB, SIG_DESC_SET(SCU500, 5));
SIG_EXPR_LIST_DECL_SESG(Y1, EMMCDAT4, EMMCDAT4, SIG_DESC_SET(SCU404, 0));
PIN_DECL_3(Y1, GPIO18E0, FWSPI18CS, VBCS, EMMCDAT4);
FUNC_GROUP_DECL(EMMCDAT4, Y1);

#define Y2 241
SIG_EXPR_LIST_DECL_SESG(Y2, FWSPI18CK, FWSPI18, SIG_DESC_SET(SCU500, 3));
SIG_EXPR_LIST_DECL_SESG(Y2, VBCK, VB, SIG_DESC_SET(SCU500, 5));
SIG_EXPR_LIST_DECL_SESG(Y2, EMMCDAT5, EMMCDAT5, SIG_DESC_SET(SCU404, 1));
PIN_DECL_3(Y2, GPIO18E1, FWSPI18CK, VBCK, EMMCDAT5);
FUNC_GROUP_DECL(EMMCDAT5, Y2);

#define Y3 242
SIG_EXPR_LIST_DECL_SESG(Y3, FWSPI18MOSI, FWSPI18, SIG_DESC_SET(SCU500, 3));
SIG_EXPR_LIST_DECL_SESG(Y3, VBMOSI, VB, SIG_DESC_SET(SCU500, 5));
SIG_EXPR_LIST_DECL_SESG(Y3, EMMCDAT6, EMMCDAT6, SIG_DESC_SET(SCU404, 2));
PIN_DECL_3(Y3, GPIO18E2, FWSPI18MOSI, VBMOSI, EMMCDAT6);
FUNC_GROUP_DECL(EMMCDAT6, Y3);

#define Y4 243
SIG_EXPR_LIST_DECL_SESG(Y4, FWSPI18MISO, FWSPI18, SIG_DESC_SET(SCU500, 3));
SIG_EXPR_LIST_DECL_SESG(Y4, VBMISO, VB, SIG_DESC_SET(SCU500, 5));
SIG_EXPR_LIST_DECL_SESG(Y4, EMMCDAT7, EMMCDAT7, SIG_DESC_SET(SCU404, 3));
PIN_DECL_3(Y4, GPIO18E3, FWSPI18MISO, VBMISO, EMMCDAT7);
FUNC_GROUP_DECL(EMMCDAT7, Y4);

FUNC_GROUP_DECL(FWSPI18, Y1, Y2, Y3, Y4);
...
#define A4 252
SIG_EXPR_LIST_DECL_SESG(A4, USB2ADPDP, USB2ADP, USB2ADP_DESC, SIG_DESC_SET(SCUC20, 16));
SIG_EXPR_LIST_DECL_SESG(A4, USB2ADDP, USB2AD, USB2AD_DESC);
SIG_EXPR_LIST_DECL_SESG(A4, USB2AHDP, USB2AH, USB2AH_DESC);
...
SIG_EXPR_LIST_DECL_SESG(A6, USB2BDDP, USB2BD, USB2BD_DESC);
SIG_EXPR_LIST_DECL_SESG(A6, USB2BHDP, USB2BH, USB2BH_DESC);
PIN_DECL_(A6, SIG_EXPR_LIST_PTR(A6, USB11BDP), SIG_EXPR_LIST_PTR(A6, USB2BDDP),
		SIG_EXPR_LIST_PTR(A6, USB2BHDP));

#define B6 255
SIG_EXPR_LIST_DECL_SESG(B6, USB11BDN, USB11BHID, USB11BHID_DESC);
SIG_EXPR_LIST_DECL_SESG(B6, USB2BDDN, USB2BD, USB2BD_DESC);
SIG_EXPR_LIST_DECL_SESG(B6, USB2BHDN, USB2BH, USB2BH_DESC);
PIN_DECL_(B6, SIG_EXPR_LIST_PTR(B6, USB11BDN), SIG_EXPR_LIST_PTR(B6, USB2BDDN),
		SIG_EXPR_LIST_PTR(B6, USB2BHDN));

FUNC_GROUP_DECL(USB11BHID, A6, B6);
FUNC_GROUP_DECL(USB2BD, A6, B6);
FUNC_GROUP_DECL(USB2BH, A6, B6);
...
static const struct aspeed_pin_group aspeed_g6_groups[] = {
	...
	ASPEED_PINCTRL_GROUP(EMMCDAT4),
	ASPEED_PINCTRL_GROUP(EMMCDAT5),
	ASPEED_PINCTRL_GROUP(EMMCDAT6),
	ASPEED_PINCTRL_GROUP(EMMCDAT7),
...
static const struct aspeed_pin_function aspeed_g6_functions[] = {
	...
	ASPEED_PINCTRL_FUNC(FWSPI18),
	ASPEED_PINCTRL_FUNC(FWSPIABR),
	ASPEED_PINCTRL_FUNC(FWQSPID),
	...
	ASPEED_PINCTRL_FUNC(EMMCDAT4),
	ASPEED_PINCTRL_FUNC(EMMCDAT5),
	ASPEED_PINCTRL_FUNC(EMMCDAT6),
	ASPEED_PINCTRL_FUNC(EMMCDAT7),
...
#define SP_PULL_DOWN_CONFIG(pin, reg, offset) \
	{ PIN_CONFIG_BIAS_PULL_DOWN, { pin, pin }, reg, offset },\
	{ PIN_CONFIG_BIAS_DISABLE, { pin, pin }, reg, offset }\

#define SP_PULL_UP_CONFIG(pin, reg, offset) \
	{ PIN_CONFIG_BIAS_PULL_UP, { pin, pin }, reg, offset },\
	{ PIN_CONFIG_BIAS_DISABLE, { pin, pin }, reg, offset }\

static struct aspeed_pin_config aspeed_g6_configs[] = {
	/* GPIOB7 */
	SP_PULL_DOWN_CONFIG(J24, SCU610, 15),
	/* GPIOB6 */
	SP_PULL_DOWN_CONFIG(H25, SCU610, 14),
	/* GPIOB5 */
	SP_PULL_DOWN_CONFIG(G26, SCU610, 13),
	/* GPIOB4 */
	SP_PULL_DOWN_CONFIG(J23, SCU610, 12),
	/* GPIOB3 */
	SP_PULL_DOWN_CONFIG(J25, SCU610, 11),
	/* GPIOB2 */
	SP_PULL_DOWN_CONFIG(H26, SCU610, 10),
	/* GPIOB1 */
	SP_PULL_DOWN_CONFIG(K23, SCU610, 9),
	/* GPIOB0 */
	SP_PULL_DOWN_CONFIG(J26, SCU610, 8),

	/* GPIOH3 */
	SP_PULL_DOWN_CONFIG(A17, SCU614, 27),
	/* GPIOH2 */
	SP_PULL_DOWN_CONFIG(C18, SCU614, 26),
	/* GPIOH1 */
	SP_PULL_DOWN_CONFIG(B18, SCU614, 25),
	/* GPIOH0 */
	SP_PULL_DOWN_CONFIG(A18, SCU614, 24),

	/* GPIOL7 */
	SP_PULL_DOWN_CONFIG(C14, SCU618, 31),
	/* GPIOL6 */
	SP_PULL_DOWN_CONFIG(B14, SCU618, 30),
	/* GPIOL5 */
	SP_PULL_DOWN_CONFIG(F15, SCU618, 29),
	/* GPIOL4 */
	SP_PULL_DOWN_CONFIG(C15, SCU618, 28),
	
	/* GPIOJ7 */
	SP_PULL_UP_CONFIG(D19, SCU618, 15),
	/* GPIOJ6 */
	SP_PULL_UP_CONFIG(C20, SCU618, 14),
	/* GPIOJ5 */
	SP_PULL_UP_CONFIG(A19, SCU618, 13),
	/* GPIOJ4 */
	SP_PULL_UP_CONFIG(C19, SCU618, 12),
	/* GPIOJ3 */
	SP_PULL_UP_CONFIG(D20, SCU618, 11),
	/* GPIOJ2 */
	SP_PULL_UP_CONFIG(E19, SCU618, 10),
	/* GPIOJ1 */
	SP_PULL_UP_CONFIG(A20, SCU618, 9),
	/* GPIOJ0 */
	SP_PULL_UP_CONFIG(B20, SCU618, 8),

	/* GPIOI7 */
	SP_PULL_DOWN_CONFIG(A15, SCU618, 7),
	/* GPIOI6 */
	SP_PULL_DOWN_CONFIG(B16, SCU618, 6),
	/* GPIOI5 */
	SP_PULL_DOWN_CONFIG(E16, SCU618, 5),
	/* GPIOI4 */
	SP_PULL_DOWN_CONFIG(C16, SCU618, 4),
	/* GPIOI3 */
	SP_PULL_DOWN_CONFIG(D16, SCU618, 3),
	/* GPIOI2 */
	SP_PULL_DOWN_CONFIG(E17, SCU618, 2),
	/* GPIOI1 */
	SP_PULL_DOWN_CONFIG(A16, SCU618, 1),
	/* GPIOI0 */
	SP_PULL_DOWN_CONFIG(D17, SCU618, 0),

	/* GPIOP7 */
	SP_PULL_DOWN_CONFIG(Y23, SCU61C, 31),
	/* GPIOP6 */
	SP_PULL_DOWN_CONFIG(AB24, SCU61C, 30),
	/* GPIOP5 */
	SP_PULL_DOWN_CONFIG(AB23, SCU61C, 29),
	/* GPIOP4 */
	SP_PULL_DOWN_CONFIG(W23, SCU61C, 28),
	/* GPIOP3 */
	SP_PULL_DOWN_CONFIG(AA24, SCU61C, 27),
	/* GPIOP2 */
	SP_PULL_DOWN_CONFIG(AA23, SCU61C, 26),
	/* GPIOP1 */
	SP_PULL_DOWN_CONFIG(W24, SCU61C, 25),
	/* GPIOP0 */
	SP_PULL_DOWN_CONFIG(AB22, SCU61C, 24),

	/* GPIOO7 */
	SP_PULL_DOWN_CONFIG(AC23, SCU61C, 23),
	/* GPIOO6 */
	SP_PULL_DOWN_CONFIG(AC24, SCU61C, 22),
	/* GPIOO5 */
	SP_PULL_DOWN_CONFIG(AC22, SCU61C, 21),
	/* GPIOO4 */
	SP_PULL_DOWN_CONFIG(AD25, SCU61C, 20),
	/* GPIOO3 */
	SP_PULL_DOWN_CONFIG(AD24, SCU61C, 19),
	/* GPIOO2 */
	SP_PULL_DOWN_CONFIG(AD23, SCU61C, 18),
	/* GPIOO1 */
	SP_PULL_DOWN_CONFIG(AD22, SCU61C, 17),
	/* GPIOO0 */
	SP_PULL_DOWN_CONFIG(AD26, SCU61C, 16),

	/* GPION7 */
	SP_PULL_DOWN_CONFIG(M26, SCU61C, 15),
	/* GPION6 */
	SP_PULL_DOWN_CONFIG(N26, SCU61C, 14),
	/* GPION5 */
	SP_PULL_DOWN_CONFIG(M23, SCU61C, 13),
	/* GPION4 */
	SP_PULL_DOWN_CONFIG(P26, SCU61C, 12),
	/* GPION3 */
	SP_PULL_DOWN_CONFIG(N24, SCU61C, 11),
	/* GPION2 */
	SP_PULL_DOWN_CONFIG(N25, SCU61C, 10),
	/* GPION1 */
	SP_PULL_DOWN_CONFIG(N23, SCU61C, 9),
	/* GPION0 */
	SP_PULL_DOWN_CONFIG(P25, SCU61C, 8),

	/* GPIOM7 */
	SP_PULL_DOWN_CONFIG(D13, SCU61C, 7),
	/* GPIOM6 */
	SP_PULL_DOWN_CONFIG(C13, SCU61C, 6),
	/* GPIOM5 */
	SP_PULL_DOWN_CONFIG(C12, SCU61C, 5),
	/* GPIOM4 */
	SP_PULL_DOWN_CONFIG(B12, SCU61C, 4),
	/* GPIOM3 */
	SP_PULL_DOWN_CONFIG(E14, SCU61C, 3),
	/* GPIOM2 */
	SP_PULL_DOWN_CONFIG(A12, SCU61C, 2),
	/* GPIOM1 */
	SP_PULL_DOWN_CONFIG(B13, SCU61C, 1),
	/* GPIOM0 */
	SP_PULL_DOWN_CONFIG(D14, SCU61C, 0),


	/* GPIOS7 */
	SP_PULL_DOWN_CONFIG(T24, SCU620, 23),
	/* GPIOS6 */
	SP_PULL_DOWN_CONFIG(P23, SCU620, 22),
	/* GPIOS5 */
	SP_PULL_DOWN_CONFIG(P24, SCU620, 21),
	/* GPIOS4 */
	SP_PULL_DOWN_CONFIG(R26, SCU620, 20),
	/* GPIOS3*/
	SP_PULL_DOWN_CONFIG(R24, SCU620, 19),
	/* GPIOS2 */
	SP_PULL_DOWN_CONFIG(T26, SCU620, 18),
	/* GPIOS1 */
	SP_PULL_DOWN_CONFIG(T25, SCU620, 17),
	/* GPIOS0 */
	SP_PULL_DOWN_CONFIG(R23, SCU620, 16),

	/* GPIOR7 */
	SP_PULL_DOWN_CONFIG(U26, SCU620, 15),
	/* GPIOR6 */
	SP_PULL_DOWN_CONFIG(W26, SCU620, 14),
	/* GPIOR5 */
	SP_PULL_DOWN_CONFIG(T23, SCU620, 13),
	/* GPIOR4 */
	SP_PULL_DOWN_CONFIG(U25, SCU620, 12),
	/* GPIOR3*/
	SP_PULL_DOWN_CONFIG(V26, SCU620, 11),
	/* GPIOR2 */
	SP_PULL_DOWN_CONFIG(V24, SCU620, 10),
	/* GPIOR1 */
	SP_PULL_DOWN_CONFIG(U24, SCU620, 9),
	/* GPIOR0 */
	SP_PULL_DOWN_CONFIG(V25, SCU620, 8),

	/* GPIOX7 */
	SP_PULL_DOWN_CONFIG(AB10, SCU634, 31),
	/* GPIOX6 */
	SP_PULL_DOWN_CONFIG(AF9, SCU634, 30),
	/* GPIOX5 */
	SP_PULL_DOWN_CONFIG(AD9, SCU634, 29),
	/* GPIOX4 */
	SP_PULL_DOWN_CONFIG(AB9, SCU634, 28),
	/* GPIOX3*/
	SP_PULL_DOWN_CONFIG(AF8, SCU634, 27),
	/* GPIOX2 */
	SP_PULL_DOWN_CONFIG(AC9, SCU634, 26),
	/* GPIOX1 */
	SP_PULL_DOWN_CONFIG(AA9, SCU634, 25),
	/* GPIOX0 */
	SP_PULL_DOWN_CONFIG(AE8, SCU634, 24),

	/* GPIOV7 */
	SP_PULL_DOWN_CONFIG(AF15, SCU634, 15),
	/* GPIOV6 */
	SP_PULL_DOWN_CONFIG(AD15, SCU634, 14),
	/* GPIOV5 */
	SP_PULL_DOWN_CONFIG(AE14, SCU634, 13),
	/* GPIOV4 */
	SP_PULL_DOWN_CONFIG(AE15, SCU634, 12),
	/* GPIOV3*/
	SP_PULL_DOWN_CONFIG(AC15, SCU634, 11),
	/* GPIOV2 */
	SP_PULL_DOWN_CONFIG(AD14, SCU634, 10),
	/* GPIOV1 */
	SP_PULL_DOWN_CONFIG(AF14, SCU634, 9),
	/* GPIOV0 */
	SP_PULL_DOWN_CONFIG(AB15, SCU634, 8),

	/* GPIOZ7 */
	SP_PULL_DOWN_CONFIG(AF10, SCU638, 15),
	/* GPIOZ6 */
	SP_PULL_DOWN_CONFIG(AD11, SCU638, 14),
	/* GPIOZ5 */
	SP_PULL_DOWN_CONFIG(AA11, SCU638, 13),
	/* GPIOZ4 */
	SP_PULL_DOWN_CONFIG(AC11, SCU638, 12),
	/* GPIOZ3*/
	SP_PULL_DOWN_CONFIG(AB11, SCU638, 11),

	/* GPIOZ1 */
	SP_PULL_DOWN_CONFIG(AD10, SCU638, 9),
	/* GPIOZ0 */
	SP_PULL_DOWN_CONFIG(AC10, SCU638, 8),

	/* GPIOY6 */
	SP_PULL_DOWN_CONFIG(AC12, SCU638, 6),
	/* GPIOY5 */
	SP_PULL_DOWN_CONFIG(AF12, SCU638, 5),
	/* GPIOY4 */
	SP_PULL_DOWN_CONFIG(AE12, SCU638, 4),
	/* GPIOY3 */
	SP_PULL_DOWN_CONFIG(AA12, SCU638, 3),
	/* GPIOY2 */
	SP_PULL_DOWN_CONFIG(AE11, SCU638, 2),
	/* GPIOY1 */
	SP_PULL_DOWN_CONFIG(AD12, SCU638, 1),
	/* GPIOY0 */
	SP_PULL_DOWN_CONFIG(AF11, SCU638, 0),

	/* LAD3 */
	{ PIN_CONFIG_DRIVE_STRENGTH, { AC7, AC7 }, SCU454, 30 },
	/* LAD2 */
	{ PIN_CONFIG_DRIVE_STRENGTH, { AC8, AC8 }, SCU454, 28 },
	/* LAD1 */
	{ PIN_CONFIG_DRIVE_STRENGTH, { AB8, AB8 }, SCU454, 26 },
	/* LAD0 */
	{ PIN_CONFIG_DRIVE_STRENGTH, { AB7, AB7 }, SCU454, 24 },
};
