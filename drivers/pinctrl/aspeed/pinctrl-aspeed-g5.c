...
#define SD1_8BITS_DESC	SIG_DESC_SET(SCU90, 3)

#define C12 16
#define I2C10_DESC	SIG_DESC_SET(SCU90, 23)
SIG_EXPR_LIST_DECL_SINGLE(SCL10, I2C10, I2C10_DESC);
SIG_EXPR_DECL(SD1CLK, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1CLK, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1CLK, SD1, SD1_8BITS);
MS_PIN_DECL(C12, GPIOC0, SD1CLK, SCL10);

#define A12 17
SIG_EXPR_LIST_DECL_SINGLE(SDA10, I2C10, I2C10_DESC);
SIG_EXPR_DECL(SD1CMD, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1CMD, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1CMD, SD1, SD1_8BITS);
...
SIG_EXPR_DECL(SD1DAT0, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1DAT0, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1DAT0, SD1, SD1_8BITS);
MS_PIN_DECL(B12, GPIOC2, SD1DAT0, SCL11);

#define D9  19
SIG_EXPR_LIST_DECL_SINGLE(SDA11, I2C11, I2C11_DESC);
SIG_EXPR_DECL(SD1DAT1, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1DAT1, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1DAT1, SD1, SD1_8BITS);
...
SIG_EXPR_DECL(SD1DAT2, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1DAT2, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1DAT2, SD1, SD1_8BITS);
MS_PIN_DECL(D10, GPIOC4, SD1DAT2, SCL12);

#define E12 21
SIG_EXPR_LIST_DECL_SINGLE(SDA12, I2C12, I2C12_DESC);
SIG_EXPR_DECL(SD1DAT3, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1DAT3, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1DAT3, SD1, SD1_8BITS);
...
SIG_EXPR_DECL(SD1CD, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1CD, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1CD, SD1, SD1_8BITS);
MS_PIN_DECL(C11, GPIOC6, SD1CD, SCL13);

#define B11 23
SIG_EXPR_LIST_DECL_SINGLE(SDA13, I2C13, I2C13_DESC);
SIG_EXPR_DECL(SD1WP, SD1, SD1_DESC);
SIG_EXPR_DECL(SD1WP, SD1_8BITS, SD1_DESC, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_DUAL(SD1WP, SD1, SD1_8BITS);
...
SIG_EXPR_LIST_DECL_SINGLE(SD1DAT4, SD1_8BITS, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_SINGLE(GPIOD2, GPIOD2);
SIG_EXPR_DECL(GPID2IN, GPID2, GPID2_DESC);
SIG_EXPR_DECL(GPID2IN, GPID, GPID_DESC);
SIG_EXPR_LIST_DECL_DUAL(GPID2IN, GPID2, GPID);
MS_PIN_DECL_(F20, SIG_EXPR_LIST_PTR(SD2DAT0), SIG_EXPR_LIST_PTR(SD1DAT4),
		  SIG_EXPR_LIST_PTR(GPID2IN), SIG_EXPR_LIST_PTR(GPIOD2));

#define D20 27
SIG_EXPR_LIST_DECL_SINGLE(SD2DAT1, SD2, SD2_DESC);
SIG_EXPR_LIST_DECL_SINGLE(SD1DAT5, SD1_8BITS, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_SINGLE(GPIOD3, GPIOD3);
SIG_EXPR_DECL(GPID2OUT, GPID2, GPID2_DESC);
SIG_EXPR_DECL(GPID2OUT, GPID, GPID_DESC);
SIG_EXPR_LIST_DECL_DUAL(GPID2OUT, GPID2, GPID);
MS_PIN_DECL_(D20, SIG_EXPR_LIST_PTR(SD2DAT1), SIG_EXPR_LIST_PTR(SD1DAT5),
		  SIG_EXPR_LIST_PTR(GPID2OUT), SIG_EXPR_LIST_PTR(GPIOD3));
...
SIG_EXPR_LIST_DECL_SINGLE(SD1DAT6, SD1_8BITS, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_SINGLE(GPIOD4, GPIOD4);
SIG_EXPR_DECL(GPID4IN, GPID4, GPID4_DESC);
SIG_EXPR_DECL(GPID4IN, GPID, GPID_DESC);
SIG_EXPR_LIST_DECL_DUAL(GPID4IN, GPID4, GPID);
MS_PIN_DECL_(D21, SIG_EXPR_LIST_PTR(SD2DAT2), SIG_EXPR_LIST_PTR(SD1DAT6),
		  SIG_EXPR_LIST_PTR(GPID4IN), SIG_EXPR_LIST_PTR(GPIOD4));

#define E20 29
SIG_EXPR_LIST_DECL_SINGLE(SD2DAT3, SD2, SD2_DESC);
SIG_EXPR_LIST_DECL_SINGLE(SD1DAT7, SD1_8BITS, SD1_8BITS_DESC);
SIG_EXPR_LIST_DECL_SINGLE(GPIOD5, GPIOD5);
SIG_EXPR_DECL(GPID4OUT, GPID4, GPID4_DESC);
SIG_EXPR_DECL(GPID4OUT, GPID, GPID_DESC);
SIG_EXPR_LIST_DECL_DUAL(GPID4OUT, GPID4, GPID);
MS_PIN_DECL_(E20, SIG_EXPR_LIST_PTR(SD2DAT3), SIG_EXPR_LIST_PTR(SD1DAT7),
		  SIG_EXPR_LIST_PTR(GPID4OUT), SIG_EXPR_LIST_PTR(GPIOD5));

FUNC_GROUP_DECL(SD1_8BITS, C12, A12, B12, D9, D10, E12, C11, B11, F20, D20, D21, E20);
...
#define A18 56
SIG_EXPR_LIST_DECL_SINGLE(TXD7, TXD7, COND1, SIG_DESC_SET(SCU94, 5));
SIG_EXPR_LIST_DECL_SINGLE(NCTS6, UART6, COND1, UART6_DESC);
MS_PIN_DECL(A18, GPIOH0, TXD7, NCTS6);

#define B18 57
SIG_EXPR_LIST_DECL_SINGLE(RXD7, RXD7, COND1, SIG_DESC_SET(SCU94, 5));
SIG_EXPR_LIST_DECL_SINGLE(NDCD6, UART6, COND1, UART6_DESC);
MS_PIN_DECL(B18, GPIOH1, RXD7, NDCD6);
FUNC_GROUP_DECL(UART7, A18, B18);

#define D17 58
/*SIG_EXPR_LIST_DECL_SINGLE(DASHD17, DASHD17, COND1, SIG_DESC_SET(SCU94, 6));*/
SIG_EXPR_LIST_DECL_SINGLE(TXD8, TXD8, COND1, SIG_DESC_SET(SCU94, 6));
SIG_EXPR_LIST_DECL_SINGLE(NDSR6, UART6, COND1, UART6_DESC);
MS_PIN_DECL(D17, GPIOH2, TXD8, NDSR6);

#define C17 59
/*SIG_EXPR_LIST_DECL_SINGLE(DASHC17, DASHC17, COND1, SIG_DESC_SET(SCU94, 6));*/
SIG_EXPR_LIST_DECL_SINGLE(RXD8, RXD8, COND1, SIG_DESC_SET(SCU94, 6));
SIG_EXPR_LIST_DECL_SINGLE(NRI6, UART6, COND1, UART6_DESC);
MS_PIN_DECL(C17, GPIOH3, RXD8, NRI6);

FUNC_GROUP_DECL(UART8, D17, C17);

#define A17 60
/*SIG_EXPR_LIST_DECL_SINGLE(DASHA17, DASHA17, COND1, SIG_DESC_SET(SCU94, 7));*/
SIG_EXPR_LIST_DECL_SINGLE(TXD9, TXD9, COND1, SIG_DESC_SET(SCU94, 7));
SIG_EXPR_LIST_DECL_SINGLE(NDTR6, UART6, COND1, UART6_DESC);
MS_PIN_DECL(A17, GPIOH4, TXD9, NDTR6);

#define B17 61
/*SIG_EXPR_LIST_DECL_SINGLE(DASHB17, DASHB17, COND1, SIG_DESC_SET(SCU94, 7));*/
SIG_EXPR_LIST_DECL_SINGLE(RXD9, RXD9, COND1, SIG_DESC_SET(SCU94, 7));
SIG_EXPR_LIST_DECL_SINGLE(NRTS6, UART6, COND1, UART6_DESC);
MS_PIN_DECL(B17, GPIOH5, RXD9, NRTS6);

FUNC_GROUP_DECL(UART9, D17, C17);
...
SIG_EXPR_LIST_DECL_SINGLE(TXD10, TXD10, SIG_DESC_SET(SCU94, 8));
MS_PIN_DECL(N5, GPIOJ4, VGAHS, TXD10);
...
SIG_EXPR_LIST_DECL_SINGLE(RXD10, RXD10, SIG_DESC_SET(SCU94, 8));
MS_PIN_DECL(R4, GPIOJ5, VGAVS, RXD10);
FUNC_GROUP_DECL(VGAVS, R4);

FUNC_GROUP_DECL(UART10, N5, R4);
...
SIG_EXPR_LIST_DECL_SINGLE(TXD11, TXD11, SIG_DESC_SET(SCU94, 9));
MS_PIN_DECL(R3, GPIOJ6, DDCCLK, TXD11);
...
SIG_EXPR_LIST_DECL_SINGLE(RXD11, RXD11, SIG_DESC_SET(SCU94, 9));
MS_PIN_DECL(T3, GPIOJ7, DDCDAT, RXD11);
FUNC_GROUP_DECL(DDCDAT, T3);

FUNC_GROUP_DECL(UART11, T3, R3);
...
SIG_EXPR_LIST_DECL_SINGLE(TXD12, TXD12, SIG_DESC_SET(SCU94, 10));
MS_PIN_DECL(R22, GPIOY0, SIOS3, TXD12);
...
SIG_EXPR_LIST_DECL_SINGLE(RXD12, RXD12, SIG_DESC_SET(SCU94, 10));
MS_PIN_DECL(R21, GPIOY1, SIOS5, RXD12);
FUNC_GROUP_DECL(SIOS5, R21);

FUNC_GROUP_DECL(UART12, R21, R22);
...
SIG_EXPR_LIST_DECL_SINGLE(TXD13, TXD13, SIG_DESC_SET(SCU94, 11));
MS_PIN_DECL(P22, GPIOY2, SIOPWREQ, TXD13);
...
SIG_EXPR_LIST_DECL_SINGLE(RXD13, RXD13, SIG_DESC_SET(SCU94, 11));
MS_PIN_DECL(P21, GPIOY3, SIOONCTRL, RXD13);
FUNC_GROUP_DECL(SIOONCTRL, P21);
FUNC_GROUP_DECL(UART13, P21, P22);
...
static const struct aspeed_pin_group aspeed_g5_groups[] = {
	...
	ASPEED_PINCTRL_GROUP(SD1_8BITS),
	...
	ASPEED_PINCTRL_GROUP(UART12),
	ASPEED_PINCTRL_GROUP(UART13),
