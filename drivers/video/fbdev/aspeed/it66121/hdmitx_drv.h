...
// Macro
/////////////////////////////////////////////////////////////////////
#define Switch_HDMITX_Bank(client, x)   HDMITX_SetI2C_Byte(client, 0x0f,1, (x)&1)
#define HDMITX_OrReg_Byte(client, reg,ormask) HDMITX_SetI2C_Byte(client, reg,(ormask),(ormask))
#define HDMITX_AndReg_Byte(client, reg,andmask) HDMITX_WriteI2C_Byte(client, reg,(HDMITX_ReadI2C_Byte(client, reg) & (andmask)))
...
// Function Prototype
////////////////////////////////////////////////////
#define hdmitx_ENABLE_NULL_PKT(client)         { HDMITX_WriteI2C_Byte(client, REG_TX_NULL_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_ACP_PKT(client)          { HDMITX_WriteI2C_Byte(client, REG_TX_ACP_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_ISRC1_PKT(client)        { HDMITX_WriteI2C_Byte(client, REG_TX_ISRC1_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_ISRC2_PKT(client)        { HDMITX_WriteI2C_Byte(client, REG_TX_ISRC2_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_AVI_INFOFRM_PKT(client)  { HDMITX_WriteI2C_Byte(client, REG_TX_AVI_INFOFRM_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_AUD_INFOFRM_PKT(client)  { HDMITX_WriteI2C_Byte(client, REG_TX_AUD_INFOFRM_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_SPD_INFOFRM_PKT(client)  { HDMITX_WriteI2C_Byte(client, REG_TX_SPD_INFOFRM_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_MPG_INFOFRM_PKT(client)  { HDMITX_WriteI2C_Byte(client, REG_TX_MPG_INFOFRM_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_ENABLE_GeneralPurpose_PKT(client) { HDMITX_WriteI2C_Byte(client, REG_TX_NULL_CTRL,B_TX_ENABLE_PKT|B_TX_REPEAT_PKT); }
#define hdmitx_DISABLE_VSDB_PKT(client)        { HDMITX_WriteI2C_Byte(client, REG_TX_3D_INFO_CTRL,0); }
#define hdmitx_DISABLE_NULL_PKT(client)        { HDMITX_WriteI2C_Byte(client, REG_TX_NULL_CTRL,0); }
#define hdmitx_DISABLE_ACP_PKT(client)         { HDMITX_WriteI2C_Byte(client, REG_TX_ACP_CTRL,0); }
#define hdmitx_DISABLE_ISRC1_PKT(client)       { HDMITX_WriteI2C_Byte(client, REG_TX_ISRC1_CTRL,0); }
#define hdmitx_DISABLE_ISRC2_PKT(client)       { HDMITX_WriteI2C_Byte(client, REG_TX_ISRC2_CTRL,0); }
#define hdmitx_DISABLE_AVI_INFOFRM_PKT(client) { HDMITX_WriteI2C_Byte(client, REG_TX_AVI_INFOFRM_CTRL,0); }
#define hdmitx_DISABLE_AUD_INFOFRM_PKT(client) { HDMITX_WriteI2C_Byte(client, REG_TX_AUD_INFOFRM_CTRL,0); }
#define hdmitx_DISABLE_SPD_INFOFRM_PKT(client) { HDMITX_WriteI2C_Byte(client, REG_TX_SPD_INFOFRM_CTRL,0); }
#define hdmitx_DISABLE_MPG_INFOFRM_PKT(client) { HDMITX_WriteI2C_Byte(client, REG_TX_MPG_INFOFRM_CTRL,0); }
#define hdmitx_DISABLE_GeneralPurpose_PKT(client) { HDMITX_WriteI2C_Byte(client, REG_TX_NULL_CTRL,0); }
...
// #endif // SUPPORT_DEGEN
    ...
    BOOL setHDMITX_SyncEmbeddedByVIC(struct i2c_client *client, BYTE VIC,BYTE bInputSignalType);
#endif
...
void setHDMITX_NLPCMAudio(struct i2c_client *client, BOOL bSPDIF);
...
SYS_STATUS HDMITX_WriteI2C_Byte(struct i2c_client *client, BYTE RegAddr,BYTE d);
...
//SYS_STATUS HDMITX_ToggleBit(struct i2c_client *client, BYTE Reg,BYTE n);
