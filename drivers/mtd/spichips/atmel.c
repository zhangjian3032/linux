...
static struct spi_flash_info atmel_data [] = 
{
	...
	{ "Atmel at26f004"   , 0x1F, 0x0004, 0x100000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 8   },} },

	/* Atmel 25DF 64K Sectors */
	{ "Atmel at25df041a" , 0x1F, 0x0144, 0x100000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 8   },} },
	{ "Atmel at25df641"  , 0x1F, 0x0048, 0x800000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 128 },} },

	/* Atmel 26DF 64K Sectors */
	{ "Atmel at26df081a" , 0x1F, 0x0145, 0x100000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 16  },} },
	{ "Atmel at26df161a" , 0x1F, 0x0146, 0x200000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 32  },} },
	{ "Atmel at26df161"  , 0x1F, 0x0046, 0x200000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 32  },} },
	{ "Atmel at26df321"  , 0x1F, 0x0047, 0x400000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 64  },} },
};
