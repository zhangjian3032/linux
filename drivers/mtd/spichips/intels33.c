...
static struct spi_flash_info s33_data [] = 
{
	...
	{ "Intel S33 16Mb"  , 0x89, 0x1189, 0x200000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 32  },} },
	{ "Intel S33 32Mb"  , 0x89, 0x1289, 0x400000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 64  },} },
	{ "Intel S33 64Mb"  , 0x89, 0x1389, 0x800000 , SPI_FLAG_NONE, 1, {{ 0, 64  * 1024, 128 },} },
};
