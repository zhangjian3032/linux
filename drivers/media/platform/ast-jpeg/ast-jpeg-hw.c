...
void ast_jpeg_reset(void __iomem *regs)
{
	unsigned long reg;
...
void ast_jpeg_poweron(void __iomem *regs)
{
	writel(S5P_POWER_ON, regs + S5P_JPGCLKCON);
}

void ast_jpeg_input_raw_mode(void __iomem *regs, unsigned long mode)
{
	unsigned long reg, m;
...
void ast_jpeg_proc_mode(void __iomem *regs, unsigned long mode)
{
	unsigned long reg, m;
...
void ast_jpeg_subsampling_mode(void __iomem *regs, unsigned int mode)
{
	unsigned long reg, m;
...
unsigned int ast_jpeg_get_subsampling_mode(void __iomem *regs)
{
	return readl(regs + S5P_JPGMOD) & S5P_SUBSAMPLING_MODE_MASK;
}

void ast_jpeg_dri(void __iomem *regs, unsigned int dri)
{
	unsigned long reg;
...
void ast_jpeg_qtbl(void __iomem *regs, unsigned int t, unsigned int n)
{
	unsigned long reg;
...
void ast_jpeg_htbl_ac(void __iomem *regs, unsigned int t)
{
	unsigned long reg;
...
void ast_jpeg_htbl_dc(void __iomem *regs, unsigned int t)
{
	unsigned long reg;
...
void ast_jpeg_y(void __iomem *regs, unsigned int y)
{
	unsigned long reg;
...
void ast_jpeg_x(void __iomem *regs, unsigned int x)
{
	unsigned long reg;
...
void ast_jpeg_rst_int_enable(void __iomem *regs, bool enable)
{
	unsigned long reg;
...
void ast_jpeg_data_num_int_enable(void __iomem *regs, bool enable)
{
	unsigned long reg;
...
void ast_jpeg_final_mcu_num_int_enable(void __iomem *regs, bool enbl)
{
	unsigned long reg;
...
int ast_jpeg_timer_stat(void __iomem *regs)
{
	return (int)((readl(regs + S5P_JPG_TIMER_ST) & S5P_TIMER_INT_STAT_MASK)
		     >> S5P_TIMER_INT_STAT_SHIFT);
}

void ast_jpeg_clear_timer_stat(void __iomem *regs)
{
	unsigned long reg;
...
void ast_jpeg_enc_stream_int(void __iomem *regs, unsigned long size)
{
	unsigned long reg;
...
int ast_jpeg_enc_stream_stat(void __iomem *regs)
{
	return (int)(readl(regs + S5P_JPG_ENC_STREAM_INTST) &
		     S5P_ENC_STREAM_INT_STAT_MASK);
}

void ast_jpeg_clear_enc_stream_stat(void __iomem *regs)
{
	unsigned long reg;
...
void ast_jpeg_outform_raw(void __iomem *regs, unsigned long format)
{
	unsigned long reg, f;
...
void ast_jpeg_jpgadr(void __iomem *regs, unsigned long addr)
{
	writel(addr, regs + S5P_JPG_JPGADR);
}

void ast_jpeg_imgadr(void __iomem *regs, unsigned long addr)
{
	writel(addr, regs + S5P_JPG_IMGADR);
}

void ast_jpeg_coef(void __iomem *regs, unsigned int i,
...
void ast_jpeg_start(void __iomem *regs)
{
	writel(1, regs + S5P_JSTART);
}

int ast_jpeg_result_stat_ok(void __iomem *regs)
{
	return (int)((readl(regs + S5P_JPGINTST) & S5P_RESULT_STAT_MASK)
		     >> S5P_RESULT_STAT_SHIFT);
}

int ast_jpeg_stream_stat_ok(void __iomem *regs)
{
	return !(int)((readl(regs + S5P_JPGINTST) & S5P_STREAM_STAT_MASK)
		      >> S5P_STREAM_STAT_SHIFT);
}

void ast_jpeg_clear_int(void __iomem *regs)
{
...
unsigned int ast_jpeg_compressed_size(void __iomem *regs)
{
